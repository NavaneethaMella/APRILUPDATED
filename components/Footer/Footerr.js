    ...
    <footer className="footer">
      <div className="footer-top">
        <div className="footer-section about-us">
          <img src="/logo.png" alt="MBS Pharma LLC" className="logo" />
        ...
        <div className="footer-section callback-form">
      ...
      <div className="footer-bottom">
        <p>Copyright © 2025 <a href="https://mbspharmas.com">mbspharmas.com</a>, Inc. All Rights Reserved</p>

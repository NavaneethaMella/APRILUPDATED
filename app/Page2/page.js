...
const Regulatory = () => {
  return (
    <div className="service-page">
      <h1>Regulatory</h1>
      <ul>
        <li>Regulatory Strategy Development and Guidance (sub bullet – Brand and Generics)</li>
        <li>Regulatory Agent Services</li>
        <li>Regulatory dossier development, compilation, ePublishing and submission</li>
        <li>General Regulatory Consulting</li>
      </ul>
    </div>
  );
};
